...
Default configuration file for:
    - a two-view parallelbeam scanner geometry
...
from lib.forward_model.scanner_template import ScannerTemplate,\
                                               default_two_view_parallel

# -----------------------------------------------------------------------------
# Step 1: Specify dataset parameter:

bags_to_create = range(1, 10)                  # Number of bags to create
sim_dir        = 'results/example_two_view_parallelbeam/' # simulation directory
# -----------------------------------------------------------------------------
...
scanner_mdl = ScannerTemplate(geometry='parallel',
                              scan='circular',
                              machine_dict=default_two_view_parallel.machine_geometry,
                              recon='fbp',
                              recon_dict=default_two_view_parallel.recon_params,
                              pscale=1.0)
