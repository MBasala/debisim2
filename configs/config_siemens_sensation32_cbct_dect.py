...
sim_dir        = 'results/example_siemens_sensation32_cbct_dect/'
# -----------------------------------------------------------------------------
...
xray_source_specs = dict(num_spectra=2,
                         ...
                         spectra=[os.path.join(SPECTRA_DIR,
                                  ...
                                  os.path.join(SPECTRA_DIR,
                                               'example_spectrum_100kV.txt')
                                  ],
    dosage=[2.2752e7, 8.684e6]
)
# -----------------------------------------------------------------------------
